...
**[urlpassivefinder](https://github.com/hix3-io/urlpassivefinder)**
High-performance passive URL discovery in Go — concurrent worker pools, streaming architecture,
6+ sources (Wayback, CommonCrawl, OTX, URLScan, crt.sh, VirusTotal, GitHub). `Go · zero-config · recon`
